...
namespace LDtkLevelManager
{
    ...
    /// <see cref="UniverseLevelBehaviour"/> about the level's state. This is needed to know when to
    ...
    public interface ILevelFlowSubject
    {
        ...
        /// </summary>
        void LeaveLevel(UniverseLevelBehaviour levelBehaviour);

        /// <summary>
        /// Called when the level is entered, meaning that the player should
        /// regain control of the character.
        /// </summary>
        void EnterLevel(UniverseLevelBehaviour levelBehaviour);
        ...
        void PlaceInLevel(UniverseLevelBehaviour levelBehaviour, Vector3 position, int facingDirectionSign);
    }
}